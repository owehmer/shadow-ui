...
@Component({
  selector: 'app-my-content-short',
  templateUrl: './my-content-short.component.html',
  styleUrls: ['./my-content-short.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MyContentComponentShort implements DialogWithAbort, DialogWithOk, DialogWithOpenChanges, DialogWithResult {
